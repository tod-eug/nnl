...
public class DividendMapper {
    ...
    public static Dividend mapDividend(String currency, Element element) {
        ...
        double tax = Double.parseDouble(tds.get(5).ownText().replace(",", ""));
        double payment = Double.parseDouble(tds.get(6).ownText().replace(",", ""));
        double divPerShare = Double.parseDouble(tds.get(7).ownText().replace(",", ""));
        double dividendGross = Double.parseDouble(tds.get(8).ownText().replace(",", ""));
        double dividendNet = Double.parseDouble(tds.get(9).ownText().replace(",", ""));
